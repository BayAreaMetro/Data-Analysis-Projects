setwd("C:/projects/bridge-transactions/Two-Bridge-Users")
library(readxl)
library(dplyr)
library(lubridate)
library(knitr)
...
# 
# df_rj2 <- read_excel(rj_path, sheet=1)

#download the data here: https://mtcdrive.box.com/s/015yl1mjkohlzkni6w2m6g9re39ybsjm
#received from ray j on 09/21/2017
rj2_path <- "081417 trans2_.xlsx"

df_rj2 <- read_excel(rj2_path, sheet=1)
...
ftr_08_14_2017_commute <- transactions_to_bridge_users_rj2(df_rj2, commute=TRUE)

#ftr_04_12_2017_all_hours <- transactions_to_bridge_users_bz(df_bz, commute=FALSE)
ftr_08_14_2017_all_hours <- transactions_to_bridge_users_rj2(df_rj2, commute=FALSE)

#write data out
library(readr)
write_excel_csv(ftr_08_14_2017_commute$devices_bridges,"08_14_2017_devices_by_bridge_commute_take2.csv")
write_excel_csv(ftr_08_14_2017_commute$summary_two_bridge,"08_14_2017_commute_summary_table_take2.csv")

write_excel_csv(ftr_08_14_2017_all_hours$devices_bridges,"08_14_2017_devices_by_bridge_all_hours_take2.csv")
write_excel_csv(ftr_08_14_2017_all_hours$summary_two_bridge,"08_14_2017_all_hours_summary_table_take2.csv")
