...
q2 <- quantile(tracts_zones_area$taz_area_over_tract_area, c(.10,.90), na.rm=TRUE)
...
map3 <- mapview(tracts3, color="green", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
...
mapshot(map3, "review_area_outliers.html", selfcontained = FALSE)
