...
mapview(sliver_sample, col.regions="red", map.types=c('Stamen.Toner.Light'))
...
mapview(tracts1, col.regions="green", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
  ...
  mapview(intersection1, col.regions="red", alpha=0.8, map.types=c('Stamen.Toner.Light'))
...
mapview(tracts2, col.regions="green", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
  mapview(taz2, col.regions="blue", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
  mapview(intersection2, col.regions="red", alpha=0.8, map.types=c('Stamen.Toner.Light'))
...
q2 <- quantile(tracts_zones_area$taz_area_over_tract_area, c(.05,.80), na.rm=TRUE)
...
mapview(tracts3, col.regions="green", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
  mapview(taz3, col.regions="blue", alpha=0.8, map.types=c('Stamen.Toner.Light')) +
  mapview(intersection3, col.regions="red", alpha=0.8, map.types=c('Stamen.Toner.Light'))
