...
write_excel_csv(ethnicity_table_wide,"above_average_ethnic_and_racial_groups_by_tract_coeff_var_30.csv")

openxlsx::write.xlsx(ethnicity_table_wide,"above_average_ethnic_and_racial_groups_by_tract_coeff_var_30.xlsx")
```
