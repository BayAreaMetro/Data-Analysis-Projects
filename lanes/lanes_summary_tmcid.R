...
lanes_query <- read_file("lanes_summary_by_tmc.sql")
...
st_write(nw_sf_sum_sample_oakland, "tomtom_nw_tmc_sum_sample_oakland.gpkg", driver="GPKG")
...
st_write(nw_sf_sum_sample_san_ramon, "tomtom_nw_tmc_sum_sample_san_ramon.gpkg", driver="GPKG")
